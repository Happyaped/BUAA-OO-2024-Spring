...
public class UpElevator extends Thread {
    ...
    public UpElevator(Integer idElevator, RequestTable elevatorSchedule,
    ...
    public void run() {
        while (true) {
            Advice advice = strategy.getUpAdvice(nowNum, nowFloor,
    ...
    public void openAndClose() {
        TimableOutput.println("OPEN-" + nowFloor + "-" + idElevator + "-B");
        try {
            sleep(400);
        } catch (InterruptedException e) {
            e.printStackTrace();
        ...
        out();
        in();
        TimableOutput.println("CLOSE-" + nowFloor + "-" + idElevator + "-B");
    }
